                                    ...
                                    <div className="transaction-header">
                                        <div className="transaction-header-content">
                                            <div className="date-view">
                                                <span className="view-day">09</span>
                                                <span className="view-date">
                                                <span className="day">Sunday</span>
                                                <span className="month">January 2022</span>
                                                </span>
                                            </div>
                                        ...
                                        <div className="transaction-item-wrap">
                                            <div className="transaction-item">
                                                <div className="transaction-item-content">
                                                    <img alt="" className="transaction-icon" src="https://static.moneylover.me/img/icon/ic_category_foodndrink.png"/>
                                                    ...
                                                    <p className="notes">starlite rice from nepali store</p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="transaction-item-content">
                                                    ...
                                                    <p className="transaction-category-wrap">
                                                        <span className="transaction-row">
                                                            ...
                                                            <span className="expense amount">$4</span>
                                                        </span>
                                                    </p>
                                                    <p className="notes">Coles brand</p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="transaction-item-content">
                                                    ...
                                                    <p className="transaction-category-wrap">
                                                        <span className="transaction-row">
                                                            ...
                                                            <span className="expense amount">$10</span>
                                                        </span>
                                                    </p>
                                                    <p className="notes">Chicken</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="transaction-list">
                                    <div className="transaction-header">
                                        <div className="transaction-header-content">
                                            ...
                                            <div className="vendor">
                                                <span className="vendor-name">Woolworths</span>
                                            </div>
